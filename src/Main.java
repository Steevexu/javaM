...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch(userSelected){
                case 1:
                    System.out.println("Empreinte Carbone du poste de consommation de l'Alimentation : "+ u1.calc_impact_alimentation());
                    break;
                case 2:
                    System.out.println("Empreinte Carbone du poste de consommation des Dépenses et Biens de Consommations  : "+ u1.calc_impact_bienConso());
                    break;
                case 3:
                    System.out.println("Empreinte Carbone du poste de consommation des Services Publics : "+ u1.calc_impact_services());
                    break;
                case 4:
                    System.out.println("Empreinte Carbone du poste de consommation de Logement : "+ u1.calc_impact_logement());
                    break;
                case 5:
                    System.out.println("Empreinte Carbone du poste de consommation de Déplacement et Transport : "+ u1.calc_impact_transport());
                    break;
                case 6:
                    System.out.println("Empreinte Carbone Total de l'utilisateur : "+ u1.calculerEmpreinte());
                    break;
                case 7:
